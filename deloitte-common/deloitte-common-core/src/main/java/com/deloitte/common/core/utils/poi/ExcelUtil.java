...
import com.deloitte.common.core.utils.file.ImageUtils;
import com.deloitte.common.core.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
    ...
    public void setCellVo(Object value, Excel attr, Cell cell) {
        if (ColumnType.STRING == attr.cellType()) {
            ...
            if (StrUtil.startWithAny(cellValue, FORMULA_STR)) {
                cellValue = ReUtil.replaceFirst(cellValue, FORMULA_REGEX_STR, "\t$0");
            }
    ...
    public static String convertByExp(String propertyValue, String converterExp, String separator) {
        ...
        return StrUtil.stripEnd(propertyString.toString(), separator);
    }
