...
export const constantRoutes = [
  ...
  //数据提取
  {
    ...
    children: [
      {
        path: "index",
        component: () => import("@/views/dataExtraction/index.vue"),
        name: "dataExtraction",
        meta: { title: "数据提取" },
      },
    ],
  ...
  //数据配置
  {
    ...
    component: Layout,
    hidden: true,
    redirect: "dataConfiguration",
    children: [
      {
        path: "index",
        component: () => import("@/views/dataConfiguration/index.vue"),
  ...
  //参数配置
  {
    ...
    component: Layout,
    hidden: true,
    redirect: "parameterConfiguration",
    children: [
      {
        path: "index",
        component: () => import("@/views/parameterConfiguration/index.vue"),
