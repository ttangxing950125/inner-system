<template>
  <div class="padding20">
    <none v-if="tableData.length === 0"></none>
    <div v-else>
      ...
      <div class="pd20" v-if="!settingPage">
        <div class="flex1">
          ...
          ></el-input>
          <div class="add-btn">
            <div @click="setting(true)">
              <icon-title class="white font ml20">添加配置</icon-title>
            </div>
          </div>
        </div>
        <el-table
      ...
      <setting ref="seting" v-show="settingPage" :type="3"></setting>
      <div class="bootm pd20">
        <div class="flex">
          <div class="font ml10">计算结果</div>
          <div @click="saveFun">
            <icon-title class="seting mr10">保存配置</icon-title>
          </div>
        </div>
        <el-table
          :data="secondData"
