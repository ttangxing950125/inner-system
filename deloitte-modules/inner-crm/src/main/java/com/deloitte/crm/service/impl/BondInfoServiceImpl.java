...
public class BondInfoServiceImpl implements IBondInfoService {
    ...
    public R<BondEntityInfoVo> findAllDetail(String entityCode, String bondCode) {
        ...
        if (isABS != null) {
            ...
            result.add(new AttrValueMapDto().setName("是否为ABS"));
        }
        ...
        if (tradCode != null) {
            ...
            result.add(new AttrValueMapDto().setName("债券交易代码"));
        }
        ...
        if (bondFullName != null) {
            ...
            result.add(new AttrValueMapDto().setName("债券全称"));
        }
        ...
        if (valueDate != null) {
            ...
            result.add(new AttrValueMapDto().setName("起息日"));
        }
        ...
        if (dueCashingDate != null) {
            ...
            result.add(new AttrValueMapDto().setName("到期兑付日"));
        }
        //TODO 债务关系来源
        ...
        if (whetherViolation != null) {
            ...
            result.add(new AttrValueMapDto().setName("是否违约"));
        }
        ...
        if (violationType != null) {
            ...
            result.add(new AttrValueMapDto().setName("违约类型"));
        }
        ...
        if (violationDate != null) {
            ...
            result.add(new AttrValueMapDto().setName("违约日期"));
        }
    ...
    public R<BondEntityInfoVo> editAllDetail(BondEntityInfoVo bondInfoEditVo) {
        ...
        if (list.size() == 0) {
            return R.ok(bondInfoEditVo, BadInfo.PARAM_PROBABLY_BE_EMPTY.getInfo());
        }
        return null;
    }
