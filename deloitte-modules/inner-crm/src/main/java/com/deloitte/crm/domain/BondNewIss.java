...
public class BondNewIss implements Serializable {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(tradeCode, bondShortName, issStartDate, payDate, issScalePlan, issAmountTop, issScale, issTerm, specialTerm, bondGrade, enetityGrade, couponRate, ipoissYield, guideRate, guideRateMargin, floatRate, rateType, payFre, annoDate, issEndDate, ipoDate, ipoAddr, valueDate, expireDate, bondCodeList, fundUse, specialRule, addCreditMethod, assessOrgan, bondName, issorShortName, issorName, issorIndustryFirst, issorIndustrySecond, issorEntityNature, issorProvince, issorCity, sponsor, issSponsorGrade, sponsorEntityNature, assureRule, mainUnw, fundShare, coUnw, bookKeeper, issType, unwType, issPrice, target, bidType, bidRegion, bidDate, bidTime, bidAddr, winBidPrice, winBidRegion, subcMult, weightRate, fullCourtMult, margRate, margMult, issRate, unwMenber, issOnlineNub, onlineSubcCode, windBondTypeSecond, secondMixedCapitalBond, issStatus, isCiBond, addIssStatus, crossMarket, denom, govNewAmount, govReplaceAmount);
    }
}
