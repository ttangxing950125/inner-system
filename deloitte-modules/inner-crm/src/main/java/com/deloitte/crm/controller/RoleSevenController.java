...
public class RoleSevenController {
    ...
    @ApiImplicitParam(name="timeUnit,date",value="请传入时间单位常量 MOUTH || DAY,请传入具体日期: yyyy-mm-dd")
    ...
    @ApiImplicitParam(name="id,state",value="传入 id,传入 状态 1是忽略 2是新增")
    ...
    @ApiImplicitParam(name="creditCode,entityName",value="传入 企业统一社会信用代码,传入 企业名称")
    ...
    @ApiImplicitParam(name="creditCode,entityNewName,remarks",value="统一社会信用代码,主体新名称,备注")
