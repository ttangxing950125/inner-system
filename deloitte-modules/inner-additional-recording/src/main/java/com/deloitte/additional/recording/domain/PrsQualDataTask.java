 ...
 * @创建人 tangx
 * @创建时间 2022/11/30
 * @描述 表  prs_qual_data_task 实体
 */
@AllArgsConstructor
@NoArgsConstructor
@Data
@Builder
@TableName("prs_qual_data_task")
public class PrsQualDataTask extends BaseEntity {
    ...
    public PrsQualDataTask init(String qualCode, String baseData, String loseValue, String maxValue, String minValue, String midValue, String modeValue, String variance, String standardDeviation, String percent5, String percent25, String percent50, String percent75, String percent95) {
